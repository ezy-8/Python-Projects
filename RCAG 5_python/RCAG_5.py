...
answer1 = raw_input("What is the progress with your cube solving? (respond with 'none' if you are not on any other cases for the following questions) ") #done for the validity of the user

#Loading the specific case and CFOP situation
if answer1 == cube_progress[0] or answer1 == cube_progress[1] or answer1 == cube_progress[2]:
	print F2L_cases[0:]
